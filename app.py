...
st.set_page_config(page_title="Le Pin - Wine Analytics", page_icon="🍇", layout="wide")
...
if live_conversion_rate is None:
    live_conversion_rate = 1.2  # Fallback to 1.0 if fetching fails
...
# Latest rate is déjà un float, pas besoin de [0]
conversion_rate = fx_series.iloc[-1][0]
...
if page == "Analyse Château - Prix & Volume":
    ...
    fx_series_full = fx_series.reindex(all_dates_needed, method='ffill').squeeze()
